...
class DevViewController: UIViewController {
    ...
    lazy var tableView: UITableView = {
           ...
           table.delegate = self
           table.register(TableViewCell.self, forCellReuseIdentifier: "TableViewCellDev")
    ...
    let products: [Product] = productList.filter { $0.typeDevice == 2 }
...
extension DevViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "TableViewCellDev", for: indexPath)
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
          ...
          let detailsVC = DetailsViewControllerDev()
